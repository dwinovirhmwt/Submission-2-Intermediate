package com.bangkit23dwinovirhmwt.storyhubsubmission2.data.paging
...
import com.bangkit23dwinovirhmwt.storyhubsubmission2.data.db.RemoteKeys
...
class StoryRemoteMediator(
    private val database: StoryHubDatabase,
        ...
        try {
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.storyHubDao().deleteAll()
                }
                ...
                database.storyHubDao().insertStory(responseData)
            }
